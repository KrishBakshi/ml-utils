import gradio as gr
from src.image_data_plot.plot_detection_data import process_yolo_zip as process_detection_zip
from src.image_data_plot.plot_segmentation_data import process_yolo_zip as process_segmentation_zip
...
with gr.Blocks(title="YOLO Visualization Tools") as demo:
    ...
    with gr.Tabs():
        ...
        with gr.Tab("Segmentation Visualizer"):
            ...
            def process_with_settings_zip(zip_file, alpha, show_polygons, segmentation_type):
                return process_segmentation_zip(zip_file, alpha=alpha, show_polygons=show_polygons, segmentation_type=segmentation_type)

            cv_submit_btn.click(
                fn=process_with_settings_zip,
                inputs=[cv_zip_input, alpha_slider, show_polygons_checkbox, segmentation_type_dropdown],
